  ...
  function GetOneImage(url)
  {
      ...
      .then((data) => 
      {
          ...
          editBtn.addEventListener('click', (event) => {
              const token = 'eyJhbGciOiJodHRwOi8vd3d3LnczLm9yZy8yMDAxLzA0L3htbGRzaWctbW9yZSNobWFjLXNoYTI1NiIsInR5cCI6IkpXVCJ9.eyJodHRwOi8vc2NoZW1hcy54bWxzb2FwLm9yZy93cy8yMDA1LzA1L2lkZW50aXR5L2NsYWltcy9uYW1lIjoiMTIzIiwiaHR0cDovL3NjaGVtYXMubWljcm9zb2Z0LmNvbS93cy8yMDA4LzA2L2lkZW50aXR5L2NsYWltcy9yb2xlIjoiSnVuaW9yIiwiZXhwIjoxNjgyNjQ5NjQ5fQ.U_PZmqXJkbWh1jsCJA9mzEep0H1w6IWC6q2azP5j88Y';
              const headers = {
                  Authorization: `Bearer ${LoginToken}`,
              };
