    ...
    .then(data => {
        ...
        <div class="title">
                ...
                <div class="flex" style="margin-top:30px;">
                    ...
                    <input type="button" value="取消送出" class="reserve-botton" onclick="location.href='./Senior_detail_check_homework.html?id=${data.homework_id}';">
                </div>
        `;
        console.log(data);
    }) 
...
function update(id) {
    ...
    .then(data => {
        console.log(data);
        window.location.href="./Senior_check_homework.html";
    });
}
