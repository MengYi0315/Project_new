            ...
            data.forEach((item) => {
                ...
                if (item.name === name) {
                    ...
                    <tr>
                        ...
                        <td class="row">
                            <input type="button" value="修改" class="edit-row-button"  onclick="location.href='./Senior-Test-EditTest.html?id=${item.test_id}';">
                ...
                else
                {
                    ...
                    <tr>
                        ...
                        <td class="row">
                            <input type="button" value="前往預約" class="row-button"  onclick="location.href='./Senior-Test-ReserveTest.html?id=${item.test_id}';">
                        </td>
                    </tr>
                    `;
                }
                ...
                if (item.tester_name === name) {
                    ...
                    if (item.is_fail === true) {
                        ...
                        <tr>
                            ...
                            <td class="row" style="width:20%;">
                                ...
                                <input type="button" value="重新預約" class="row-button" onclick="location.href='./Senior-Test-ReserveTest.html?id=${item.test_id}'">
                    ...
                    if ((item.is_fail === false) && (item.is_success === false)) {
                        ...
                        <tr>
                            ...
                            <td class="row" style="width:20%;">
                            <input type="submit" value="修改" class="edit-row-button"  onclick="location.href='./Senior-Test-EditReserveTest.html?id=${item.reservetime_id}';">
